    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <c:if test="${not empty patient}">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-7">${patient.firstName} ${patient.lastName}</dd>
                                    ...
                                    <dd class="col-7">${not empty patient.phone ? patient.phone : 'Non renseigné'}</dd>

                                    <dt class="col-5">Adresse</dt>
                                    <dd class="col-7">${not empty patient.address ? patient.address : 'Non renseignée'}</dd>

                                    <dt class="col-5">Email</dt>
                                    <dd class="col-7">${not empty patient.user.email ? patient.user.email : 'Non renseigné'}</dd>
                                </dl>
                            </div>

                            <!-- Avatar or placeholder -->
                            <div class="col-lg-3 text-center d-lg-flex align-items-start justify-content-center">
                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>Allergies &amp; conditions médicales</h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <c:choose>
                                    <c:when test="${not empty currentRecord.allergies}">
                                        <span class="badge bg-danger-subtle text-danger-emphasis">${currentRecord.allergies}</span>
                                    </c:when>
                                    <c:otherwise>
                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="fas fa-pills me-2"></i>Médicaments actuels</h5>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0 align-middle">
                                        ...
                                        <c:forEach var="prescription" items="${currentPrescriptions}">
                                            <tr>
                                                <td><span class="badge bg-primary-subtle text-primary-emphasis p-2">${prescription.title}</span></td>
                ...
                <c:if test="${not empty currentRecord}">
                    <div class="card mb-4 shadow-sm">
                        <div class="card-header bg-light d-flex align-items-center">
                            <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Métriques de santé</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                                <!-- Blood pressure -->
                                <div class="col-md-4">
                                    <div class="border rounded p-3 text-center h-100">
                                        ...
                                        <h6 class="fw-semibold">Tension artérielle</h6>
                                ...
                                <div class="col-md-4">
                                    <div class="border rounded p-3 text-center h-100">
                                        ...
                                        <h6 class="fw-semibold">Température</h6>
                                        <p class="display-6 fw-normal">
                                            <c:choose>
                                            ...
                                            <div class="timeline-item mb-4 position-relative">
                                                ...
                                                <div class="ps-4">
                                                    ...
                                                    <c:if test="${not empty record.symptoms}">
                                                        <p class="mb-1"><strong>Symptômes&nbsp;:</strong> ${record.symptoms}</p>
                                                    </c:if>
                                                    <c:if test="${not empty record.treatmentPlan}">
                                                        <p class="mb-1"><strong>Plan de traitement&nbsp;:</strong> ${record.treatmentPlan}</p>
                                                    </c:if>
                ...
                <c:if test="${not empty documents}">
                    <div class="card mb-4 shadow-sm">
                        <div class="card-header bg-light">
                            <h5 class="mb-0"><i class="fas fa-file-medical me-2"></i>Documents médicaux</h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
